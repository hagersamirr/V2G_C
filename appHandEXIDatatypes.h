...
#define appHandAnonType_supportedAppProtocolRes_AppProtocol_ARRAY_SIZE 5
...
struct Station_Supported_App_protocol {
...
struct appHandAnonType_supportedAppProtocolRes {
	...
	struct appHandAppProtocolType type;
...
struct HANDLER{
	struct{
		struct Station_Supported_App_protocol array[appHandAnonType_supportedAppProtocolRes_AppProtocol_ARRAY_SIZE];
	uint16_t arrayLen;;
}ResProtocol;
};
